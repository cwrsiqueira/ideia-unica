    ...
    return (
        ...
        <div className="container">
            ...
            <select className='select' onChange={(e)=>setConvSelect(e.target.value)}>
                ...
                <option value={'toggleLowerUpperCase'}>Alternar entre maiúsculas e minúsculas começando maiúscula</option>
                <option value={'toggleUpperLowerCase'}>Alternar entre maiúsculas e minúsculas começando minúsucla</option>
